...
public class AuthenticationController {
    ...
    @PostMapping("/login")
    @ApiOperation(value = "login person",
            notes = "Return ResponseEntitiy or throw exception if user not found.")
    ...
    @ApiOperation(value = "logout person",
            notes = "Return ResponseEntitiy of result of logout.")
    ...
    @ApiOperation(value = "logout person, delete token",
            notes = "Return ResponseEntitiy of result of logout and deleting person token.")
    ...
    @ApiOperation(value = "register new person",
            notes = "Return ResponseEntitiy of result.")
    ...
    @ApiOperation(value = "refresh person token",
            notes = "Return ResponseEntitiy of result.")
